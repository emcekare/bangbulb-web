const team = [
  { role: "Kreatif direktör", name: "Evren Akşahin", q: "Sabah kahvesi olmadan slogan yazmaz." },
  { role: "Art direktör", name: "Anıl Birsin.", q: "Mood board'u 47 kez değiştirir, bir kez gönderir." },
  { role: "Sosyal Medya Direktörü", name: "Niran Birsin", q: "Algoritmayı düşmanı sayıp sonra arkadaş eder." },
        ...
        <div className="team__grid reveal">
          {team.map((m, i) => (
            <div className="member" key={i} data-cursor="merhaba">
              <div className="member__avatar" data-init={initials(m.name)}></div>
